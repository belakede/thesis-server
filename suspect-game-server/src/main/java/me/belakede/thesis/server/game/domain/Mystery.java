...
public class Mystery implements Serializable {
    private static final long serialVersionUID = 1487624547533319634L;
    ...
    public Mystery(Suspect suspect, Room room, Weapon weapon) {
        this(null, suspect, room, weapon);
    }

    public Mystery(Game game, Suspect suspect, Room room, Weapon weapon) {
        this.game = game;
